...
public class RenderRegion {
    ...
    public static class RenderRegionArenas {
        ...
        public RenderRegionArenas(CommandList commandList, StagingBuffer stagingBuffer) {
            ...
            this.vertexBuffers = createArena(commandList, expectedVertexCount * ChunkModelVertexFormats.getDefaultChunkVertexType().getBufferVertexFormat().getStride(), stagingBuffer);
